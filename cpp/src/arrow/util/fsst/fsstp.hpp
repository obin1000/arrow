...
inline void read_data(const unsigned char *src, const size_t src_size, atomic_queue::AtomicQueue2<fsst_block, QUEUE_SIZE> *data_queue, size_t block_size) {
...
inline size_t compress_buffer(const unsigned char *src, size_t src_length, unsigned char *dst, size_t block_size) {
    atomic_queue::AtomicQueue2<fsst_block, QUEUE_SIZE> data_queue{};
    atomic_queue::AtomicQueue2<fsst_block, QUEUE_SIZE> blocks_queue{};
